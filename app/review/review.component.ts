...
export class ReviewComponent implements OnInit {
  ...
  findUpvotes(){
    this.httpClient.getUpvotes().subscribe(
      res=>{
        this.x=res[0];
        this.y=res[1];
        this.z=res[2];
  ...
  findFolderResult(){
    this.httpClient.getFolderReviews().subscribe(
      res=>{
        this.folderResult=res;
        console.log(this.folderResult)
        //this.wait()
        this.findImgResult();
      })
  }
  ...
  findImgResult(){
    this.httpClient.getImgReviews().subscribe(
      res=>{
        this.imgResult=res;
        console.log(this.imgResult)
        this.findCorrections();
      }
    )
  }

  findCorrections(){
    this.httpClient.get_corrections().subscribe(
      res=>{
        this.corrections=res;
        console.log(this.corrections)
        this.findCorrectionResult()
      }
    ) 
  }
  
  findCorrectionResult(){
    this.httpClient.getCorrectionReviews().subscribe(
      res=>{
        this.correction_result=res;
        //console.log(this.imgResult)
      }
    )
  }
